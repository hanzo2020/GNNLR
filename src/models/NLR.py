...
class NLR(BaseModel):
    ...
    def __init__(self, variable_num, user_num, v_vector_size, layers, r_logic, r_length, sim_scale, sim_alpha,
                 *args, **kwargs):
    ...
    def _init_weights(self):
        ...
        self.transformerencoder = torch.nn.TransformerEncoder(self.encoder, num_layers=1)
